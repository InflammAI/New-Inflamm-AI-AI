...
export class VytalSyncController {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      console.log('VytalSyncController initialized successfully');
    } catch (error) {
      console.error('VytalSyncController initialization failed, using mock mode:', error);
  ...
  async grantAccess(req: Request, res: Response): Promise<void> {
    try {
      ...
      const accessRequest: AccessGrantRequest = req.body;
