...
export class VytalSyncController {
  ...
  async storeHealthData(req: ExpressRequest, res: Response): Promise<void> {
    try {
  ...
  async getHealthData(req: ExpressRequest, res: Response): Promise<void> {
    try {
  ...
  async getServerPublicKey(req: ExpressRequest, res: Response): Promise<void> {
    try {
  ...
  async grantAccess(req: ExpressRequest, res: Response): Promise<void> {
    try {
  ...
  async revokeAccess(req: ExpressRequest, res: Response): Promise<void> {
    try {
      const requestorPublicKey = req.headers['x-public-key'] as string;
  ...
  async getAccessRules(req: ExpressRequest, res: Response): Promise<void> {
    try {
      const requestorPublicKey = req.headers['x-public-key'] as string;
  ...
  async deleteHealthData(req: ExpressRequest, res: Response): Promise<void> {
    try {
      const requestorPublicKey = req.headers['x-public-key'] as string;
  ...
  async getMetrics(req: ExpressRequest, res: Response): Promise<void> {
    try {
  ...
  async cleanupExpiredAccess(req: ExpressRequest, res: Response): Promise<void> {
    try {
